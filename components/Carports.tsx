...
const Carports: React.FC<ProjectsPreviewSectionProps> = ({ onNavigate }) => {
        ...
        <div className="flex flex-1 flex-col items-center w-full">
            ...
            <div className="w-full max-w-[1440px] p-4 lg:p-6">
                <div
                    ...
                    style={{ backgroundImage: 'linear-gradient(to right, rgba(0, 0, 0, 0.7) 0%, rgba(0, 0, 0, 0.3) 60%, rgba(0, 0, 0, 0.1) 100%),  url("images/c2.jpg")' }}
                >
                    <div className="flex flex-col gap-4 max-w-[640px] text-left animate-fade-in-up">
                        ...
                        <h2 className="text-gray-200 text-lg lg:text-xl font-normal leading-relaxed max-w-[540px]">
                            Delivering high-performance carport structures that maximize space efficiency and durability. From parking lot installations to custom architectural solutions, we design optimized steel systems built for strength, safety, and long-term reliability.
                        </h2>
            ...
            <div className="w-full bg-white border-b border-border-light py-12">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-10 grid grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div className="flex flex-col gap-1 border-l-4 border-primary pl-4">
                        <span className="text-4xl font-bold text-primary">5GW+</span>
                        <span className="text-sm text-text-muted font-medium">Carport Capacity Designed</span>
                    </div>

                    <div className="flex flex-col gap-1 border-l-4 border-primary pl-4">
                        <span className="text-4xl font-bold text-primary">120+</span>
                        <span className="text-sm text-text-muted font-medium">Parking Sites Delivered</span>
                    </div>

                    <div className="flex flex-col gap-1 border-l-4 border-primary pl-4">
                        <span className="text-4xl font-bold text-primary">3M+</span>
                        <span className="text-sm text-text-muted font-medium">Sq.m Covered Area</span>
                    </div>

                    <div className="flex flex-col gap-1 border-l-4 border-primary pl-4">
                        <span className="text-4xl font-bold text-primary">-35%</span>
                        <span className="text-sm text-text-muted font-medium">Installation Time</span>
                    </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-border-light pb-8">
                    <div className="flex flex-col gap-3 max-w-[700px]">
                        ...
                        <h2 className="text-text-main text-4xl font-bold leading-tight tracking-tight">
                            Carport Engineering Services
                        </h2>
                        <p className="text-text-muted text-lg leading-relaxed">
                            We design high-performance carports optimized for structural integrity,
                            parking efficiency, and architectural integration.
                        </p>
                    </div>
                </div>
